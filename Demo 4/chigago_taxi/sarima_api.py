...
def predict_custom_trained_model(
    ...
    location: str,
    endpoint_id: str,
    # O novo parâmetro é n_periods, que define a duração da previsão
    n_periods: int
):
    """
    ...
    # Constrói o payload 'instances' no formato que a sua API espera
...
endpoint_id = "6667953082275463168"
